...
Route::group(array('prefix' => 'admin','before' => 'auth.admin|lock'), function()
{
    ...
    // Reportes Routing
    Route::post('ajax_reportes/',['as'=>'admin.ajax_reportes','uses'=> 'ReportsController@ajax_reportes']);
...
//    Route::get('reports/transacciones','ReportsController@reportestran',['as'=>'admin']);
    ...
    //  Logs Routing
    Route::get('ajax_logs/',['as'=>'admin.ajax_logs','uses'=> 'LogsController@ajax_logs']);
