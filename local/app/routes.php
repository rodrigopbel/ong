...
Route::group(array('prefix' => 'admin','before' => 'auth.admin|lock'), function()
{
    ...
    Route::get('personales/personalesLogin/{id}',['as'=>'admin.personales.perLogin','uses'=>'PersonalController@benLogin']);
    ...
    // Reportes Routing
    Route::get('ajax_reportes/{$id}',['as'=>'admin.ajax_reportes','uses'=> 'ReportsController@ajax_reportes']);
