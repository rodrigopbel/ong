...
class AyudasController extends \AdminBaseController {
    ...
    public function ajax_ayudas()
    {
	    ...
	    $result =
		    Ayuda::select('ayudas.id','beneficiarios.beneficiarioID','apellidos','personal.personalID','personal.nombres','requerimiento','centroSalud','nit','numfactura','gastos','ayudas.created_at')
