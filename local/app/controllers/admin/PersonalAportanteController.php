 ...
 */
class PersonalAportanteController extends \AdminBaseController {
    /**
    ...
    {
        parent::__construct();
        $this->data['personalAportanteOpen']  =   'active open';
        $this->data['pageTitle']     =   'Personal Aportante';
    }
    public function index()
    {
        $this->data['personales']       =    Personal::where('tipoPersonal', '=', 'Aportante')->get();
        $this->data['personalAportanteActive']   =   'active';
        Debugbar::info($this->data['personales'] );

        return View::make('admin.personalAportante.index', $this->data);
    }
    /**
