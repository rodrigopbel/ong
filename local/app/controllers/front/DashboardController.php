...
//        Total leaves except
        ...
        $this->data['beneficiarioID']  =    Ayuda::where('aportanteID', '=', Auth::personales()->get()->personalID)->select('beneficiarioID')->get();
...
//        $this->data['beneficiarios']   =    Beneficiario::all();
        ...
        $this->data['beneficiarios']      =    Beneficiario::where('beneficiarioID', '=','90870' )->
                                                        select('beneficiarioID')->get();
...
//        dd($this->data['zonificacion']);
	...
	public function index()
	{
      ...
      return  $this->data['beneficiarioID'];
