        ...
        <div class="col-md-6 col-sm-6">
            <div class="portlet box red-sunglo">
                <div class="portlet-title">
                    ...
                    <div class="actions">
                        <a href="javascript:;"
                           onclick="UpdateDetails('{{$beneficiario->beneficiarioID}}','company');return false"
                ...
                <div class="portlet-body">
                    ...
                    <div class="form-body">
                        <div class="form-group">
                            ...
                            <div class="col-md-9">
                                <input type="text" name="beneficiarioID" class="form-control" readonly
                                       value="{{$beneficiario->beneficiarioID}}">
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-3">
                                <div class="input-group input-medium date date-picker" data-date-format="dd-mm-yyyy"
                                     data-date-viewmode="years">
                                    <input type="text" class="form-control" name="fechaing" readonly
                                           value="@if(empty($beneficiario->fechaing))00-00-0000 @else {{date('d-m-Y',strtotime($beneficiario->fechaing))}} @endif">
        												<span class="input-group-btn">
        												<button class="btn default" type="button"><i
                                                                    class="fa fa-calendar"></i></button>
        												</span>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-3">
                                <div class="input-group input-medium date date-picker" data-date-format="dd-mm-yyyy"
                                     data-date-viewmode="years">
                                    <input type="text" class="form-control" name="fecha_desvinculacion" readonly
                                           value="@if(empty($beneficiario->fecha_desvinculacion)) @else {{date('d-m-Y',strtotime($beneficiario->fecha_desvinculacion))}} @endif">
                                                            <span class="input-group-btn">
                                                            <button class="btn default" type="button"><i
                                                                        class="fa fa-calendar"></i></button>
                                                            </span>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-3">
                                <input type="checkbox" value="activo" onchange="remove_exit();" class="make-switch"
                                       name="status" @if($beneficiario->status=='activo')checked
                                       @endif data-on-color="success" data-on-text="Activo" data-off-text="Inactivo"
                        ...
                        @foreach($beneficiario->getSoldonacion as $solicitud)
                            <div id="salary{{$solicitud->id}}">
                                <div class="form-group">
                                    <div class="col-md-5">
                                        <input type="text" class="form-control" name="tipo[{{$solicitud->id}}]"
                                               value="{{$solicitud->tipo}}">
                                    </div>

                                    <div class="col-md-5">
                                        <input type="text" class="form-control" name="monto[{{$solicitud->id}}]"
                                               value="{{$solicitud->monto}}">
                                    </div>

                                    <div class="col-md-2">
                                        <a class="btn btn-sm red"
                                           onclick="del('{{$solicitud->id}}','{{$solicitud->tipo}}')"><i
            ...
            <div class="portlet box red-sunglo">
                <div class="portlet-title">
                    ...
                    <div class="actions">
                        <a href="javascript:;"
                           onclick="UpdateDetails('{{$beneficiario->beneficiarioID}}','zonificacion');return false"
                           data-loading-text="Actualizando..." class="demo-loading-btn-ajax btn btn-sm btn-default ">
                            <i class="fa fa-save"></i> Guardar </a>
                    </div>
                </div>
                <div class="portlet-body">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-9">
                                <input type="text" name="departamento" class="form-control"
                                       value="{{$zonificacion->departamento or ''}}">
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-md-9">
                                <input type="text" name="provincia" class="form-control"
                                       value="{{$zonificacion->provincia or ''}}">
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-md-9">
                                <input type="text" name="localidad" class="form-control"
                                       value="{{$zonificacion->localidad or ''}}">
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-9">
                                <textarea class="form-control" name="otros"
                                          rows="3">{{$zonificacion->otros or '' }}</textarea>
                            </div>
                        </div>
                    </div>
                    {{Form::close()}}
            ...
            <div class="col-md-6 col-sm-6">
                <div class="portlet box purple-wisteria">
                    <div class="portlet-title">
                        ...
                        <div class="actions">
                            <button onclick="$('#documents_details_form').submit();" data-loading-text="Actualizando..."
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-3">
                                        @if(isset($documents['certnac']))
                                            <a href="https://docs.google.com/viewer?url={{URL::to('beneficiarios_documents/certnac/'.$documents['certnac'])}}"
                                               target="_blank" class="btn purple">Ver CN</a>
                                        @endif
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-md-3">
                                        @if(isset($documents['croquis']))
                                            <a href="https://docs.google.com/viewer?url={{URL::to('beneficiarios_documents/croquis/'.$documents['croquis'])}}"
                                               target="_blank" class="btn purple">Ver Croquis</a>
                                        @endif
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-md-3">
                                        @if(isset($documents['CIprueba']))
                                            <a href="https://docs.google.com/viewer?url={{URL::to('beneficiarios_documents/CIprueba/'.$documents['CIprueba'])}}"
                                               target="_blank" class="btn purple">View CI</a>
                                        @endif
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-md-3">
                                        @if(isset($documents['perfil']))
                                            <a href="https://docs.google.com/viewer?url={{URL::to('beneficiarios_documents/perfil/'.$documents['perfil'])}}"
                                               target="_blank" class="btn purple">Ver Perfil</a>
                                        @endif
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-md-3">
                                        @if(isset($documents['IDProof']))
                                            <a href="https://docs.google.com/viewer?url={{URL::to('beneficiarios_documents/solicitud/'.$documents['solicitud'])}}"
                                               target="_blank" class="btn purple">Ver Diagnostico</a>
                                        @endif
                                    </div>
                                </div>
                            </div>
            ...
            <div class="col-md-6 col-sm-6">
                <div class="portlet box red-sunglo">
                    <div class="portlet-title">
                        ...
                        <div class="actions">
                            <a href="javascript:;"
                               onclick="UpdateDetails('{{$responsable->personalID}}','responsable');return false"
                               data-loading-text="Updating..." class="demo-loading-btn-ajax btn btn-sm btn-default ">
                                <i class="fa fa-save"></i> Guardar </a>
                        </div>
                    </div>
                    <div class="portlet-body">
                        ...
                        <div class="form-body">
                            <div class="form-group">
                                ...
                                <div class="col-md-9">
                                    <input type="text" name="ciResponsable" class="form-control"
                                           value="{{$responsable->personalID  or ''}}">
                                </div>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-9">
                                    <input type="text" name="apellidosResponsable" class="form-control"
                                           value="{{$responsable->apellidos or ''}}">
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-md-9">
                                    <input type="text" name="ocupacionResponsable" class="form-control"
                                           value="{{$responsable->ocupacion or ''}}">
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-md-9">
                                    <select class="form-control" name="parentesco">
                                        <option value="Ninguno" @if($responsable->parentesco=='Ninguno')selected @endif>
                                            Ninguno
                                        </option>
                                        <option value="Papa/Mama"  @if($responsable->parentesco=='Papa / Mama')
                                                selected @endif>Papa / Mama
                                        </option>
                                        <option value="Tio/Tia"  @if($responsable->parentesco=='Tio / Tia')
                                                selected @endif>Tio /Tia
                                        </option>
                                        <option value="Hermano/Hermana"  @if($responsable->parentesco=='Hermano / Hermana')
                                                selected @endif>Hermano / Hermana
                                        </option>
                                        <option value="OtroFamilia"  @if($responsable->parentesco=='OtroFamiliar')
                                                selected @endif>Otro Familiar
                                        </option>
                                    </select>
                                </div>
                            </div>
